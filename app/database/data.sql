...
('Pret Personnel', '2025-04-01', 1, 24, 50000.00, 7.50, 1),
...
-- Donnees pour la table pret
INSERT INTO pret (date_pret, type_pret_id, compte_id, montant, duree) VALUES
('2025-06-01', 1, 1, 4000.00, 12),
('2025-06-02', 2, 2, 200000.00, 96),
('2025-06-03', 3, 1, 5000.00, 24);
...
-- Donnees pour la table remboursement
INSERT INTO remboursement (pret_id, numero_periode, base, interet, amortissement, a_payer, date_echeance) VALUES
(1, 1, 4000.00, 25.00, 308.33, 333.33, '2025-07-01'),
(1, 2, 3691.67, 23.07, 310.26, 333.33, '2025-08-01'),
(1, 3, 3381.41, 21.13, 312.20, 333.33, '2025-09-01'),
(2, 1, 200000.00, 700.00, 1383.33, 2083.33, '2025-07-02'),
(2, 2, 198616.67, 695.06, 1388.27, 2083.33, '2025-08-02'),
(3, 1, 5000.00, 12.50, 195.83, 208.33, '2025-07-03'),
(3, 2, 4804.17, 12.01, 196.32, 208.33, '2025-08-03');
