...
Flight::route('POST /gestionPret/ajouter', [ $PretClientController, 'ajouterPret']);
...
Flight::route('GET /gestionPret/fichePret/@id', [ $PretClientController, 'getPretCompletById' ]);
